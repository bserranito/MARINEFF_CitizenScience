...
data_amb <- read_excel(here('data','raw',"BDD_2021_SP_VD.xlsx"), sheet=1) %>% filter(Quadrat=='RECIF') %>%
...
data_val<- read_excel(here('data','raw',"BDD_2021_SP_VD.xlsx"), sheet=2) %>% filter(Quadrat=='RECIF') %>% na.omit() %>%
